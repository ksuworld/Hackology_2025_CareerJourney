...
import com.uworld.careerjourney.myjourney.CareerTimelineScreen
import com.uworld.careerjourney.myjourney.DashboardScreen
                    ...
                    NavHost(navController = navController, startDestination = "select") {
                        composable("select") {
                            Column(
                                ...
                                when (tabIndex) {
                                    0 -> DashboardScreen(onNavigateToMilestone = { journey ->
